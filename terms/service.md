...
(5) you will not access the Site or the Marketplace Offerings through automated or non-human means, whether through a bot, script or otherwise; 
...
Definitions: "Host": A user who signs up for an account on the InfrAI platform with the purpose of listing their physical hardware on the platform to be leased by clients. "Client": A user who signs up for an account on the InfrAI platform with the purpose of browsing or renting from the available list of host hardware offerings. By using the InfrAI service as a Host, you agree that you will not attempt to inspect, view, or in any way interact with client containers "Instances". This includes, but is not limited to, inspecting logs, files, system memory, and network traffic. By using the InfrAI service as a Client, you agree that you intend to use the platform for your own gain and not to the detriment of others. This means that you will not engage in nefarious behaviors including, but not limited to, sabotaging Host machines, viewing unlawful or restricted materials through Host machines or doing anything that may be construed as unlawful on a Host machine, and attempting to gain access to Host hardware that you have not paid for. InfrAI Inc will not be held liable for any actions that a Host or Client takes that is deemed unlawful. InfrAI Inc does not police or enforce what Hosts or Clients do on rented hardware, it simply brokers and automates the interactions between the two parties.


## 28. CONTACT US

In order to resolve a complaint regarding the Site or the Marketplace Offerings or to receive further information regarding use of the Site or the Marketplace Offerings, please contact us at:support@infrai.com
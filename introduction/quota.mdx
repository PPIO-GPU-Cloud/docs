...
description: Learn how to choose a GPU for your virtualization needs.
---

## Introduction

The platform offers a variety of GPU container cloud computing specifications to meet different virtualization capability needs, supporting a wide range of business applications and service scenarios.
...
**Actual supply is subject to the [Computing Power Market](https://console.paigpu.com/).**
